...
func getPodTrafficOverrides(pod *corev1.Pod, namespace *corev1.Namespace, interfaceExclusionRules *util.CompiledInterfaceExclusionRules) iptables.PodOverrides {
