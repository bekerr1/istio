...
func (cfg *IptablesConfigurator) CreateInpodRules(log *istiolog.Scope, podOverrides PodOverrides) error {
...
func (cfg *IptablesConfigurator) AppendInpodRules(podOverrides PodOverrides) *builder.IptablesRuleBuilder {
